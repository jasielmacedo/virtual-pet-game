...
public class AnimalCatCharacterButton : MonoBehaviour
{
    ...
    public Texture[] eyeTextureArray = new Texture[9];
    ...
    void OnGUI()
    {
        ...
        /////////////////////////////////////////////////////////////////////
        if (GUI.Button(new Rect(20, 660, 120, 40), "RandomEye"))
        {
            faceMesh.materials[0].SetTexture("_MainTex", eyeTextureArray[Random.Range(0, eyeTextureArray.Length)]);
        }
        if (GUI.Button(new Rect(150, 660, 70, 40), "CatEye01"))
        {
            faceMesh.materials[0].SetTexture("_MainTex", eyeTextureArray[0]);
        }
        if (GUI.Button(new Rect(220, 660, 70, 40), "CatEye02"))
        {
            faceMesh.materials[0].SetTexture("_MainTex", eyeTextureArray[1]);
        }
        if (GUI.Button(new Rect(290, 660, 70, 40), "CatEye03"))
        {
            faceMesh.materials[0].SetTexture("_MainTex", eyeTextureArray[2]);
        }
        if (GUI.Button(new Rect(360, 660, 70, 40), "CatEye04"))
        {
            faceMesh.materials[0].SetTexture("_MainTex", eyeTextureArray[3]);
        }
        if (GUI.Button(new Rect(430, 660, 70, 40), "CatEye05"))
        {
            faceMesh.materials[0].SetTexture("_MainTex", eyeTextureArray[4]);
        }
        if (GUI.Button(new Rect(500, 660, 70, 40), "CatEye06"))
        {
            faceMesh.materials[0].SetTexture("_MainTex", eyeTextureArray[5]);
        }
        /////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////
        if (GUI.Button(new Rect(720, 420, 120, 40), "Cat01"))
        {
            SceneManager.LoadScene("Cat_01");
        }

        if (GUI.Button(new Rect(720, 460, 120, 40), "Cat02"))
        {
            SceneManager.LoadScene("Cat_02");
        }

        if (GUI.Button(new Rect(720, 500, 120, 40), "Cat03"))
        {
            SceneManager.LoadScene("Cat_03");
        }
    }
